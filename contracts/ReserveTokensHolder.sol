...
/// @title ReserveTokensHolder Contract
/// @author Jordi Baylina
/// @dev This contract will hold the tokens of the developers.
///  Tokens will not be able to be collected until 1 year after the contribution ends
...
contract ReserveTokensHolder is Owned {
    ...
    function ReserveTokensHolder(address _owner, address _contribution, address _miniMeToken) {
        owner = _owner;
